...
public class OrderEntityMapper implements IOrderEntityMapper {
    ...
    public OrderEntity toEntity(Order order) {
        OrderEntity entity = OrderEntity.builder()
                ...
                .orderPendingDate(order.getOrderPendingDate())
                .orderPreparationDate(order.getOrderPreparationDate())
                .orderReadyDate(order.getOrderReadyDate())
                .orderDeliveredDate(order.getOrderDeliveredDate())
    ...
    public Order toModel(OrderEntity entity) {
        return Order.builder()
                ...
                .orderPendingDate(entity.getOrderPendingDate())
                .orderPreparationDate(entity.getOrderPreparationDate())
                .orderReadyDate(entity.getOrderReadyDate())
                .orderDeliveredDate(entity.getOrderDeliveredDate())
